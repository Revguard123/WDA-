...
export async function adviseDiscoveryTurn(input = {}, { client, model = DEFAULT_MODEL, logger = null } = {}) {
  ...
  const system = [
    'You are the War Dogs Academy Niche Advisor. Choose one focused federal-contracting lane through a short natural conversation. Sound like a helpful human coach, not a form or rubric. Use short, simple sentences. Avoid idioms, slogans, metaphors, hype, and robotic phrases.',
