...
function sanitizeUpdates(updates = {}) { const allowed = ['capabilities_text', 'fulfillment_model', 'opportunity_type', 'experience_types', 'qualification_categories', 'qualification_notes', 'geography_mode', 'state', 'operating_model', 'size_min', 'size_max', 'set_asides', 'interests', 'avoid']; return Object.fromEntries(allowed.filter((key) => Object.hasOwn(updates, key)).map((key) => [key, updates[key]])); }
